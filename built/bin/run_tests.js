...
var ASM_CONSTS = {
  ...
  5756482: $0 => window._htmlVideoData[$0].video.duration,
  5756535: $0 => window._htmlVideoData[$0].video.videoWidth,
  5756590: $0 => window._htmlVideoData[$0].video.videoHeight,
  5756646: $0 => {
  ...
  5756915: $0 => window._htmlVideoData[$0].video.currentTime,
  5756971: ($0, $1) => {
    window._htmlVideoData[$0].video.loop = $1;
  },
  5757018: $0 => window._htmlVideoData[$0].video.loop,
  5757067: ($0, $1) => {
    window._htmlVideoData[$0].video.playbackRate = $1;
  },
  5757122: $0 => window._htmlVideoData[$0].video.playbackRate,
  5757179: $0 => !window._htmlVideoData[$0].video.paused,
  5757231: $0 => window._htmlVideoData[$0].video.muted,
  5757281: ($0, $1) => {
    window._htmlVideoData[$0].video.muted = ($1 !== 0);
  },
  5757337: $0 => window._htmlVideoData[$0].video.volume,
  5757388: ($0, $1) => {
  ...
  5758434: () => "requestVideoFrameCallback" in HTMLVideoElement.prototype,
  5758504: () => {
  ...
  5758841: $0 => window._httpChannels[$0].readyState,
  5758884: ($0, $1, $2) => {
    var xhr = window._httpChannels[$0];
  ...
  5762159: () => (typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string"),
  5762281: $0 => {
